...
//      UIApplication.shared.windows.first?.layer.speed = MAXFLOAT
  ...
  func applicationWillResignActive(_ application: UIApplication) {
    ...
    // Use this method to pause ongoing tasks, disable timers, and invalidate graphics renderin@objc @objc g callbacks. Games should use this method to pause the game.
  }
